...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  if(htim->Instance==TIM1)
  {
    ...
    PA11     ------> TIM1_CH4
    */
    GPIO_InitStruct.Pin = Motor1_CH1_Pin|Motor2_CH2_Pin|Motor3_CH3_Pin|Motor4_CH4_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  else if(htim->Instance==TIM3)
  {
    ...
    PB5     ------> TIM3_CH2
    */
    GPIO_InitStruct.Pin = Motor7_CH3_Pin|Motor8_CH4_Pin|Motor5_CH1_Pin|Motor6_CH2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  else if(htim->Instance==TIM5)
  {
    ...
    PA3     ------> TIM5_CH4
    */
    GPIO_InitStruct.Pin = Arm_Servo_CH1_Pin|Roll_Servo_CH2_Pin|Pitch_Servo_CH3_Pin|Yaw_Servo_CH4_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  */
    ...
    PB15     ------> USART1_RX
    */
    GPIO_InitStruct.Pin = STLink_Tx_Pin|STLink__RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  if(huart->Instance==USART1)
  {
    ...
    PB15     ------> USART1_RX
    */
    HAL_GPIO_DeInit(GPIOB, STLink_Tx_Pin|STLink__RX_Pin);
  ...
  else if(huart->Instance==USART3)
  {
    ...
    PB11     ------> USART3_RX
    */
    HAL_GPIO_DeInit(GPIOB, HC_05_Tx_Pin|HC_05_Rx_Pin);
